...
const SpinningLogos = () => {
  ...
  return (
    <div
      style={{
        width: sizes.radiusToCenterOfIcons + sizes.iconWrapperWidth + sizes.ringPadding,
        height: sizes.radiusToCenterOfIcons + sizes.iconWrapperWidth + sizes.ringPadding,
      }}
      className="absolute right-0 top-0 z-0 grid translate-x-1/3 place-content-center rounded-full bg-secondary/50 shadow-inner"
    >
      <motion.div
        initial={{ rotate: 0 }}
        animate={{ rotate: 360 }}
        ...
        {ICON_DATA.map((icon, idx) => {
          ...
          return (
            <motion.div
              ...
              animate={{ rotate: -360 }}
              transition={TRANSITION}
              className="absolute grid place-content-center rounded-full bg-gradient-to-br from-primary-light to-primary-dark text-primary-content shadow-lg"
            >
              <icon.Icon
                style={{
