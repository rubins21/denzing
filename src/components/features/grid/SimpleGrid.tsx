...
const Item = ({
  ...
  return (
    <div>
      <h4 className="mb-1.5 flex items-start text-lg font-medium text-copy md:text-xl">
        <Icon className="mr-1.5 h-[26px] text-primary-light" />
        {title}
      </h4>
      <p className="text-sm text-copy-light md:text-base">{subtitle}</p>
    </div>
  );
};
