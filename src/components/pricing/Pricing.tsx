  ...
  return (
    <Card>
      <div className="flex flex-col items-center border-b border-border pb-6">
        <span className="mb-6 inline-block text-copy">{tier}</span>
        <span className="mb-3 inline-block text-4xl font-medium text-copy">{price}</span>
        <span className="bg-gradient-to-br from-copy to-copy-light bg-clip-text text-center text-transparent">
          {bestFor}
        </span>
      </div>
